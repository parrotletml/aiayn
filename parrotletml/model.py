...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def attention(query, key, value, mask, dropout: nn.Dropout):
        ...
        if mask is not None:
            ...
            ## A hack to make this work in mixed precision
            # attention_scores_float = attention_scores.float()
            # mask_float = mask  # .float()
            # attention_scores_float.masked_fill_(mask_float == 0, -1e9)
            # attention_scores = attention_scores_float.half()
